...
/**
 * Servlet implementation class ProfessorsList
 */
@WebServlet("/list.prof")
public class ProfessorsList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// * listCount : 총 게시글 갯수 
		listCount = new ProfessorsService().getListCount();
		...
		request.getRequestDispatcher("views/admin/professors/profList.jsp").forward(request, response);
